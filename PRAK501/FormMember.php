...
<form action="" method="post">                             
    <div class="form-group">                                 
        ...
        <?php echo (isset($_GET['id_member'])) ?  "value = '" . $row[0]["nama_member"] . "'" : "value = '' "; ?> 
    ...
    <div class="form-group">                                 
        ...
        <?php echo (isset($_GET['id_member']) ) ?  "value = '" . $row[0]["nomor_member"] . "'" : "value = '' "; ?> 
        placeholder="Nomor Member" required>                             
    </div>
    <div class="form-group">                                 
        <label for="alamat">Alamat</label>     
        <textarea class="form-control" name="alamat" id="alamat" rows="3" required>
            <?php echo (isset($_GET['id_member'])) ? $row[0]["alamat"] : ""; ?></textarea>                             
    </div>                             
    <div class="form-group">                                 
        ...
        <?php echo (isset($_GET['id_member'])) ?  "value = " . $row[0]["tgl_terakhir_bayar"] . "" : "value = '' "; ?> 
        placeholder="Tanggal Terakhir Bayar" required>                             
    </div>                             
<?php 
    if (isset($_GET['id_member'])) {    
